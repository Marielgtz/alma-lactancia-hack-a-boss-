  ...
  const validateAndUpdateField = async (fieldName, value) => {
    ...
    try {
      if (fieldName === 'logo' && file) {
        ...
        await axios.patch(`${API_BASE_URL}/update-home-data`, formData, { 
          headers: {
        ...
        await axios.patch(`${API_BASE_URL}/update-home-data`, updateData, { 
          headers: {
    ...
    <main className="settings-content">
      ...
      <form className="social-links-form">
        <label>
          ...
          />
          <button type="button" onClick={() => validateAndUpdateField('linkInstagram', settings.linkInstagram)}>
        ...
        <label>
          ...
          <input
            ...
            onChange={handleChange}
          />
          <button type="button" onClick={() => validateAndUpdateField('linkFacebok', settings.linkFacebok)}>
            Actualizar Facebook
          </button>
        </label>
        ...
        <label>
          ...
          <input
            ...
            onChange={handleChange}
          />
          <button type="button" onClick={() => validateAndUpdateField('email', settings.email)}>
            Actualizar Correo
          </button>
        </label>
      </form>
